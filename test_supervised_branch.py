...
class SupervisedBranchTests(unittest.TestCase):
    ...
    def test_tensorized_manifest_loads_precomputed_edge_wdl_targets(self):
        tree = build_slot_test_tree()
        tensorized = tensorize_tree_with_targets(
            tree,
            [0.0] * tree.num_nodes(),
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            batch, _ = dataset.collate_fn([loaded])
    ...
    def test_child_wdl_pretrainer_uses_precomputed_edge_targets_from_packed_tensorized_data(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("cts_pretrain.edge_wdl_targets_from_node_features", side_effect=AssertionError("recomputed")):
