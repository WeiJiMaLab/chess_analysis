#!/bin/bash
# Shared environment setup script for lmcos_tiny SLURM jobs.
...
export PYTHONPATH="/home/hl4291/chess_analysis/lmcos_tiny/src"
export PYTHONUNBUFFERED=1

# Validate ELO is set
: "${ELO:?ELO required (1800|2000|2200)}"

export TINY=/home/hl4291/chess_analysis/lmcos_tiny
