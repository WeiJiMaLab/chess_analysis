...
for maint in [0.0, 0.1, 0.2, 0.3]:
    config = replace(base_cfg, time_mode='linear', time_lambda=0.0015, maintenance_scale=maint, maintenance_exponent=1.0)
    ...
    print(f'maint={maint}: ceiling={kmax}', flush=True)
