...
VOC is the deep-search gain over the shallow (1-ply value-head) choice. The coupling is
**weakly positive** — more value-of-computation, longer thinks — the direction Russek-style
accounts predict. VOC is zero in ~⅔ of positions (search confirms the 1-ply pick).
...
humans deliberate on **structural complexity** (branching dominates) and barely track VOC. On
...
*Merges the former R-VOC-MQ (human VOC/MQ vs move time) and R-ORACLE-RT (oracle stop step vs
