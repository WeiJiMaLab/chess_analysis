...
#
#   bash lmcos_small/slurm/human/preprocess.sh
#
...
LOG_DIR="${PROJECT_DIR}/lmcos_small/slurm/human/logs"
...
python3 lmcos_small/src/human/preprocess/preprocess.py get_games
...
python3 lmcos_small/src/human/preprocess/preprocess.py shard
EOF
...
python3 lmcos_small/src/human/preprocess/preprocess.py merge
...
export DUCKDB_THREADS="${DUCKDB_MERGE_THREADS}"
export DUCKDB_MEMORY_LIMIT="${DUCKDB_MERGE_MEM}"
python3 lmcos_small/src/human/preprocess/preprocess.py process_moves
