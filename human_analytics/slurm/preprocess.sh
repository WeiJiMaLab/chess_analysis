...
#
#   bash human_analytics/slurm/preprocess.sh
#
...
LOG_DIR="${PROJECT_DIR}/human_analytics/slurm/logs"
...
python3 human_analytics/slurm/scripts/preprocess.py get_games
...
python3 human_analytics/slurm/scripts/preprocess.py shard
EOF
...
python3 human_analytics/slurm/scripts/preprocess.py merge
...
export DUCKDB_THREADS="${DUCKDB_MERGE_THREADS}"
export DUCKDB_MEMORY_LIMIT="${DUCKDB_MERGE_MEM}"
python3 human_analytics/slurm/scripts/preprocess.py process_moves
