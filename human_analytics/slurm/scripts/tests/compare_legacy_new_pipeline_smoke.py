...
Run from repo root::
    ...
    PYTHONPATH=human_analytics python3 human_analytics/slurm/scripts/tests/compare_legacy_new_pipeline_smoke.py \\
...
def main() -> None:
    ...
    p.add_argument(
        ...
        help=(
            ...
            "``human_analytics/slurm/scripts/tests/boundary_suite_results.json`` (and per-window JSON next to it). "
