...
**hl4291** experiments (50k tree generation, topology-full packing on hl4291 scratch) live in [`../hl4291_slurm/`](../hl4291_slurm/). See that README for current status (updated 2026-05-19).
