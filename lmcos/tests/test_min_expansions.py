"""
Tests for min_expansions (first step at which oracle_best_move_index agrees
with the final verdict and never deviates).

Run from lmcos/: pytest tests/test_min_expansions.py -v
"""
...
from analysis.min_expansions_analysis import min_expansions


class TestMinExpansions:
    """
    min_expansions(t) = first step t >= 1 at which best_idx[t] == final_best
    ...
    def test_not_first_time_seen(self):
        """
        min_expansions is NOT the first time we see the final best move —
