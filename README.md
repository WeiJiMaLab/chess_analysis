...
| `chess_analysis/lmcos_small/human/preprocess/` | **DB-table producer CLI** (the `processed_moves` ETL; analysis is cts-native, no live engine) |
...
| Resource | Content |
| :--- | :--- |
| `presentations/` | Motivation, architecture slides, **human** clock/VOC figures (Slidev decks under `presentations/src/`) |
