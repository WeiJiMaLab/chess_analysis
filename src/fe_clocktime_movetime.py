...
from utils.plots import plot_standard_analysis_quad, plot_distribution_side_by_side
...
def run_fe_analyses(df):
    ...
    plot_standard_analysis_quad(
        ...
        x_label=r"$\log(\mathrm{Clock})$" + "\n" + r"$- \mathbb{E}[\log(\mathrm{Clock}) | \mathrm{Ply}]$", 
    ...
    plot_standard_analysis_quad(
        ...
        x_label=r"$\log(\mathrm{Clock})$" + "\n" + r"$- \mathbb{E}[\log(\mathrm{Clock}) | \mathrm{Game}]$", 
    ...
    plot_standard_analysis_quad(
        ...
        x_label=r"Residual $\log(\mathrm{Clock})$" + "\n" + r"$\mid \mathrm{Game, Ply}$", 
