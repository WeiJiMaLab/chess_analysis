...
<template>
  <div class="surf-plot-wrapper w-full h-full flex flex-col bg-slate-50/30 rounded-xl border border-slate-200/50 p-4 shadow-inner">
    <div v-if="title" class="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-4 text-center border-b border-slate-200 pb-2">
      {{ title }}
    </div>
    <div ref="container" class="flex-grow cursor-move"></div>
    <div class="mt-2 text-[9px] text-center opacity-40 italic">
