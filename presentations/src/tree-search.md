...
<div class="mdl-content">
  <div class="mdl-titlefig">
    <div class="mdl-tf-left">
      ...
      <div class="mdl-conv"><span class="lbl">Root question, answered</span> People <em>do</em> meta-control — resource-rationally over <strong>decision width (the leaves they consider), satisficing once good-enough</strong> — not over engine value-of-computation. Remaining number: does the 1–2-param leaf-cost beat the bare ±0.31 floor.</div>
    </div>
    <div style="display:flex; flex-direction:column; justify-content:center; gap:1.2rem">
