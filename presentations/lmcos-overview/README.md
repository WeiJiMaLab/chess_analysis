...
mkdir -p public
ln -sf ../../../human_analytics/figures public/figures
...
Figures are served from the core `chess_analysis/human_analytics/figures` directory via a symlink in `public/figures`. 
