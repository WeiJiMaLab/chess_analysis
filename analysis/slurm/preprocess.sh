...
#
#   bash analysis/slurm/preprocess.sh
#
...
LOG_DIR="${PROJECT_DIR}/analysis/slurm/logs"
...
python3 analysis/slurm/scripts/preprocess.py get_games
...
python3 analysis/slurm/scripts/preprocess.py shard
EOF
...
python3 analysis/slurm/scripts/preprocess.py merge
...
export DUCKDB_THREADS="${DUCKDB_MERGE_THREADS}"
export DUCKDB_MEMORY_LIMIT="${DUCKDB_MERGE_MEM}"
python3 analysis/slurm/scripts/preprocess.py process_moves
