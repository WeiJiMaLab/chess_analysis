...
#
# Usage:
#   bash analysis/slurm/analysis.sh
...
python3 analysis/move_time_summary.py

echo "2. Move-time dashboards (clock, branching, material, ply)..."
python3 analysis/movetime_analysis.py --only clock clock_opp npossiblemoves pieces_exc self_pieces_exc ply

echo "3. Game Stage (Ply Pre-move Probability)..."
python3 analysis/ply_premove.py
