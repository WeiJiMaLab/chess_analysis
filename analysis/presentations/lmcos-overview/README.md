...
mkdir -p public
ln -sf ../../../analysis/figures public/figures
...
Figures are served from the core `chess_analysis/analysis/figures` directory via a symlink in `public/figures`. 
...
```bash
python analysis/move_time_summary.py
python analysis/move_time_summary.py --include_zeroT
```
